...
def main():
    ...
    mycs1 = painter.item_create("CoordSystem", "mycs1", 12, (0, 0, 0))
    mycs2 = painter.item_create("CoordSystem", "mycs2", 12, (400, 400, 0), 2, True)
    
    
    # Grid class_args: (x1,y1), (x2,y2), offset, unit ------
    mygrid1 = painter.item_create("Grid", "mygrid1", (0, 0), (1000, 1000), (0, 0, 0), 10) 
    
    
    # Star class_args: scale, origin -----------------------
    mystar1 = painter.item_create("Star", "mystar1", 15, (10, 0, 0))
    mystar2 = painter.item_create("Star", "mystar2", 15, (100, 100, 10))
    ...
    cs = "G54"
    mygcode1 = painter.item_create("GcodePath", "mygcode1", gcodes, (0,0,0), "G54", cs_offsets)
    ...
    vertexcount = 4
    mylinestrip1 = painter.item_create("Item", "mylinestrip1", vertexcount, GL_LINE_STRIP)
    color = (0.7, 0.2, 0.2, 1)
    ...
    vertexcount = 4
    mylines2 = painter.item_create("Item", "mylines2", vertexcount, GL_LINES)
    color = (0.2, 0.7, 0.2, 1)
    ...
    vertexcount = 3
    mytriangle1 = painter.item_create("Item", "mytriangle1", vertexcount, GL_TRIANGLES, False, 4)
    ...
    # Create an arbitrary filled triangle with smooth colors
    vertexcount = 4
    mytriangle2 = painter.item_create("Item", "mytriangle2", vertexcount, GL_TRIANGLE_STRIP, True)
